const whyBecomePilot = {
  data: {
    ...
    shouldBePilot: {
      imagePath: "/src/assets/sun-city-aviation-academy-should-be-pilot.jpg",
      imageAlt:
      ...
      description: `At Sun City Aviation Academy, we understand the allure of aviation and are here to guide you every step of the way. Our experienced instructors are passionate about sharing their love for flying and will provide you with the knowledge and skills needed to navigate the skies safely. From the thrill of your first solo flight to starting your pilot career, our flight school is your place to a rewarding and fulfilling aviation journey.`,
      paragraphs: [
        ...
        items: [
          {
            ...
            descriptions: [
              ...
              "At Sun City Aviation Academy, we understand the allure of aviation and are here to guide you every step of the way. Our experienced instructors are passionate about sharing their love for flying and will provide you with the knowledge and skills needed to navigate the skies safely.",
      ...
      afterListParagraphs: [
        ...
        "At <strong>Sun City Aviation Academy</strong>, we're here to support you every step of the way. Our flight school is your gateway to a world of aviation possibilities, from private pilot training to professional pilot courses.",
        `Whether you're pursuing a career in aviation, seeking new adventures, or simply following your passion for flying, we're here to help you achieve your dreams. Take the first step towards becoming a pilot and conquer of the skies with <strong>Sun City Aviation Academy</strong>.`,
      ],
    },
