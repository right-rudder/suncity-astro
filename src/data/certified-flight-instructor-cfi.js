  ...
  data: {
    ...
    becomeCFI: {
        ...
        items: [
          {
            ...
            descriptions: [
              "The Certified Flight Instructor (CFI) certification is a cornerstone of aviation education. As a CFI, you will play a pivotal role in shaping the next generation of pilots.",
              "This certification allows you to provide instruction and flight training to student pilots, helping them develop the knowledge and skills necessary to obtain their pilot certificates.",
              "CFIs are essential members of the aviation community, guiding students through ground school, flight training, and ultimately, ensuring their readiness for checkrides.",
              "In this role, you'll not only enhance your flying skills but also your ability to communicate complex aviation concepts effectively. The responsibilities of a CFI extend beyond just flying; they involve mentorship, guidance, and the empowerment of aspiring aviators.",
              "f you're passionate about sharing your love for aviation and helping others achieve their dreams of becoming pilots, then obtaining your CFI certification is a fulfilling and rewarding path.",
            ],
          },
          {
            icon: "M2.25 7.125C2.25 6.504 2.754 6 3.375 6h6c.621 0 1.125.504 1.125 1.125v3.75c0 .621-.504 1.125-1.125 1.125h-6a1.125 1.125 0 0 1-1.125-1.125v-3.75ZM14.25 8.625c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v8.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 0 1-1.125-1.125v-8.25ZM3.75 16.125c0-.621.504-1.125 1.125-1.125h5.25c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125h-5.25a1.125 1.125 0 0 1-1.125-1.125v-2.25Z",
            ...
            descriptions: [
              "The Certified Flight Instructor - Instrument (CFII) certification focuses on a crucial aspect of flight training: teaching instrument flight skills.",
              "As a CFII, you'll guide students in mastering the art of flying solely by reference to instruments, a skill that is indispensable for safe and proficient flying, especially in adverse weather conditions.",
              "Instrument flight instruction ensures that pilots can navigate and land aircraft safely when visibility is limited. CFII certification equips you with the knowledge and expertise to teach these essential skills to aspiring pilots.",
              "CFIIs play a pivotal role in building confidence and competence in instrument flying. You'll help students understand complex instrument procedures, read and interpret instruments accurately, and make sound decisions when operating in challenging weather environments.",
      ...
      afterListParagraphs: [
        ...
        "Successfully passing this checkride is the final step in becoming a Certified Flight Instructor and embarking on a fulfilling career in aviation education.",
      ],
      finalButton: {
        name: "Enroll Now",
        link: "/enroll-now",
