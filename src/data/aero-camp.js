const experienceAviationInfo = {
  data: {
    //SEO Header Stuff
    pageTitle: "AeroCamp | Youth Programs | Sun City Aviation Academy",
    pageDescription:
      "AeroCamp with Sun City Aviation Academy. Our youth programs are designed to introduce young people to the world of aviation and inspire them to pursue a career in the field.",
    pageKeywords:
      "AeroCamp, youth programs, aviation programs, aviation training, pilot training, flight school, sun city aviation academy",
    ...
    expectExpAviation: {
      ...
      paragraphs: [
        "The AeroCamp High School Program offers an exciting opportunity for high school students to do a deep dive into the world of aviation. Over three action packed days, participants will immerse themselves in the fundamentals of flight, learning about aerodynamics, radio communications, weather patterns, and more.",
