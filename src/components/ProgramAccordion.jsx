...
const ProgramAccordion = ({ step, toggled, onShow }) => {
  return (
    <div className="flex flex-col items-start rounded lg:py-3 bg-gradient-to-r from-muted-50 to-accent-100">
      <button
        id={step.title}
        onClick={onShow}
        type="button"
      ...
      >
        <h4 className="font-bold text-xl text-muted-800">{step.title}</h4>
        {toggled ? (
      ...
      >
        <li className="bg-white py-6 px-4">
